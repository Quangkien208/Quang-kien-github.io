...
require $_SERVER['DOCUMENT_ROOT'].'/NhdRight_System/nhdright_ketnoi.php'; // website config 
...
if($user['username'] == 'hungplayvn'){
    exit('CÚT IKK');
        ...
        if($user['admin'] != 100) {
            ...
            $path = $root.'/upload/log_access/log_truycap.txt';
            $f = fopen($path, 'a');
